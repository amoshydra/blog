...
description: "The speech engine's text normalizer decides whether a currency code becomes “U S dollars and forty five cents” or gets spelled out as letters. This traces the string from the DOM to the voice."
pubDate: "2026-09-19"
heroImage: "./hero.webp"
---
...
On Windows 10 and 11, NVDA speaks through Windows OneCore by default [^37]. OneCore reads the first as *"one hundred and twenty three U S dollars and forty five cents"* and the second as a spelled-out code followed by a decimal number: *"S G D one twenty three point forty five"*. No "Singapore dollars", no cents. Narrator, Microsoft's own screen reader, uses OneCore too and produces the same two readings [^2] [^16].
...
flowchart LR
    ...
    D --> E["one hundred and twenty three<br/>U S dollars and forty five cents"]
