...
```
~/code/
├─ my-lib/          # the package we are developing
│  └─ package.json  # name: "my-lib"
└─ consumer/        # the app that will consume it
   ├─ package.json  # no dependency on my-lib yet
   └─ src/index.js  # will do require('my-lib')
```
...
```
~/.npm/lib/node_modules/my-lib -> ~/code/my-lib
~/code/consumer/node_modules/my-lib -> ~/.npm/lib/node_modules/my-lib
```
...
consumer/
├─ node_modules/
│  └─ my-lib -> ~/.npm/lib/node_modules/my-lib
└─ src/
   └─ index.js
```
...
├─ node_modules/
│  ├─ my-lib -> ~/code/my-lib
│  └─ lodash@4          # hoisted for all packages
└─ packages/
   └─ consumer/
       └─ src/index.js
```
